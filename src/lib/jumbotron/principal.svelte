...
<OnMount>
	<div class="relative w-full">
		<div class="py-28 xl:py-40 bg-black flex flex-row">
			<div class="pl-20 sm:pl-36 md:pl-64 xl:pl-80 w-3/4 xl:w-1/2">
				<div
					transition:fly={{
						duration: 1000,
						x: -300,
		...
		<div
			class="pl-10 sm:pl-20 w-full min-h-20 flex flex-col flex-start xl:flex-row justify-center md:justify-start items-start gap-20 py-8 bg-amaranth bg-gradient-to-r from-amaranth-500 to-black to-80%"
		>
		...
		<div
			class="pl-10 sm:pl-[13.5rem] w-full min-h-20 flex flex-col flex-start xl:flex-row justify-center sm:justify-start items-start gap-20 md:gap-10 py-8 bg-black"
		>
